...
public class ImagePreprocessor {
	public static void main(String[] args) {
		...
		straightenImage(imageFile, new File("out.png"));
		getImageLines(new File("out.png"));

	}

	public static double straightenImage(File imageFile, File saveLocation) {
...
//        System.out.println(angle.angle);
		...
		Imgcodecs.imwrite(saveLocation.toURI().toString(), rotated);
	...
	public static ArrayList<Long> getImageLines(File f) {
		System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
//      File imageFile = new File("image.jpg");
//      System.out.println(imageFile.exists());
        ...
        Core.reduce(img, horiz_proj, 1, Core.REDUCE_AVG);
